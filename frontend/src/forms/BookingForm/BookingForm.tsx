...
import { useSearchcontext } from "../../context.js/SeacthContext";
import { useParams } from "react-router-dom";
import { useMutation } from "react-query";
import * as apiClient from '../../api-client';
import { useAppContext } from "../../context.js/AppContext";
...
const BookingForm = ({currentUser,paymentIntent}:Props) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-1 rounded-lg border border-slate-300 p-5">
            <span className="texxt-3xl font-bold">Confirm Your Details</span>
